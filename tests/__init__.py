...
try:
    ...
    # homeassistant not installed — HA integration tests are skipped.
    # New standalone daemon tests (test_extractor.py, etc.) do not require HA.
    _HA_AVAILABLE = False
    HomeAssistant = None  # type: ignore[assignment,misc]
    Entity = None  # type: ignore[assignment]
    XEntity = None  # type: ignore[assignment]
    SIGNAL_ADD_ENTITIES = None  # type: ignore[assignment]
    XRegistry = None  # type: ignore[assignment]
